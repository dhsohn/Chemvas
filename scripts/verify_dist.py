...
def verify_wheel(path: Path) -> None:
    with ZipFile(path) as wheel:
        ...
        required = {
            ...
            "chemvas/features/graph/__init__.py",
            "chemvas/features/graph/algorithms.py",
        ...
        forbidden = {
            ...
            "chemvas/main.py",
            "chemvas/ui/graph_algorithms.py",
            "chemvas/ui/graph_index_operations.py",
            "chemvas/ui/graph_rotation_policy.py",
