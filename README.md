...
- 우측 패널은 항상 표시되며 `3D Preview`에서 현재 구조를 실시간으로 확인할 수 있습니다. 마우스 드래그로 회전, 휠로 확대/축소할 수 있습니다.
...
- GitHub Actions CI도 동일하게 headless 환경(`QT_QPA_PLATFORM=offscreen`)에서 lint와 테스트를 실행합니다.
