...
- Application Quit resolves all window prompts before the final session snapshot,
  then freezes snapshots while existing asynchronous preview shutdown closes the
