...
def begin_axis_rotation_session(
    ...
    *,
    ...
    state.base_coords = ports.flatten_planar_fragments(relevant_atom_ids, state.base_coords)
    ...
    state.base_bond_length = ports.average_bond_length_for_atoms(scale_atom_ids, state.base_coords)
    return True
...
def begin_rigid_rotation_session(
    ...
    *,
    ...
    state.base_coords = ports.flatten_planar_fragments(rotation_atom_ids, state.base_coords)
    ...
    state.start_projection_center_3d = start_projection_center_3d
    state.start_projection_anchor_2d = start_projection_anchor_2d
    state.base_bond_length = ports.average_bond_length_for_atoms(set(state.atom_ids), state.base_coords)
    return True
