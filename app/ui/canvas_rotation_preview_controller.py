...
class CanvasRotationPreviewController:
    ...
    def begin_selection_rotation(self) -> bool:
        ...
        if position_items:
            state.position_snapshots = self.scene_transform.rotation_position_preview_snapshots(
                position_items
            )
        else:
    ...
    def commit_selection_rotation(self) -> None:
        ...
        if state.position_snapshots:
            self.scene_transform.restore_rotation_position_preview(state.position_snapshots)
