...
from ui.selection_service_access import select_single_structure_item_for
    ...
    *,
    ...
    return ToolServiceBundle(
        tools=ToolController(
            ...
            select_single_structure_item=lambda item: select_single_structure_item_for(canvas, item),
