...
class MainWindowContextPageStateService:
    def __init__(
        ...
        *,
        ...
        self._clear_context_bar_page_override_for_window = clear_context_bar_page_override_for_window
        self._set_context_bar_page_override_for_window = set_context_bar_page_override_for_window
