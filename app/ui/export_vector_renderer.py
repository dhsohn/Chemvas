...
from ui.export_painting import POINTS_PER_INCH, paint_scene_region
from ui.export_plan_logic import ExportPlan
from ui.export_scene_scope import exported_scene


def configure_svg_generator(generator: QSvgGenerator, plan: ExportPlan, title: str | None) -> None:
...
def configure_pdf_writer(writer: QPdfWriter, plan: ExportPlan, resolution: int, title: str | None) -> None:
...
def export_svg_file(
    ...
    with exported_scene(scene, export_items):
        ...
        try:
            paint_scene_region(painter, scene, plan, plan.out_w_pt, plan.out_h_pt, background)
        finally:
            painter.end()
