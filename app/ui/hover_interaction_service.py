...
from ui.canvas_model_access import atom_for_id, bond_for_id, has_atoms_for
...
class HoverInteractionService:
    ...
    def update_hover_highlight(self, pos: QPointF) -> None:
        ...
        preferred_hit = self._preferred_structure_hit_at_scene_pos(pos) if has_atoms else None
    ...
    def _atom_preview(self, pos: QPointF, preferred_hit) -> tuple[str | None, str | None]:
        ...
        end = bond_hover_endpoint_for(self.canvas, QPointF(atom.x, atom.y), pos, preferred_hit.id)
