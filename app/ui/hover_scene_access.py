...
def clear_hover_items_for(canvas, items: Sequence[QGraphicsItem]) -> list[QGraphicsItem]:
    return clear_hover_items_helper(canvas_scene_for(canvas), items)


def add_hover_preview_items_to_scene_for(canvas, items: Sequence[QGraphicsItem]) -> list[QGraphicsItem]:
