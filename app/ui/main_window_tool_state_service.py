...
class MainWindowToolStateService:
    ...
    def sync_tool_actions_from_canvas(self, window) -> None:
        ...
        action = self._tool_action_for_window(window, action_key) if action_key is not None else None
    ...
    def set_orbital_phase(self, window, value: str) -> None:
        self._tool_mode_controller(window).set_orbital_phase_enabled(value == "Phase On")
