...
from ui.export_raster_renderer import export_raster_file
...
from ui.export_vector_renderer import (
    export_pdf_file,
    export_svg_file,
    render_pdf_bytes,
    render_svg_bytes,
...
def export_scene(
    ...
    *,
    ...
    if fmt == "svg":
        ...
        export_raster_file(scene, path, export_items, plan, image_format, dpi, background)
    else:
...
def render_scene_to_svg_bytes(
    ...
    *,
    ...
    return render_svg_bytes(scene, list(items), _plan_for_copy_source(source), background, title)
...
def render_scene_to_pdf_bytes(
    ...
    *,
    ...
    return render_pdf_bytes(scene, list(items), _plan_for_copy_source(source), background, title)
