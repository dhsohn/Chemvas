...
from ui.bond_geometry_primitives import offset_segment, trim_segment
from ui.bond_graphics_access import bond_offset_unit_3d_for, line_normal_for
...
class BondLineGeometryService:
    ...
    def plain_double_segments(
        ...
        *,
        ...
        outer_center_seg = offset_segment(base_segment, inner_nx, inner_ny, -center_offset)
        inner_center_seg = offset_segment(base_segment, inner_nx, inner_ny, center_offset)
        ...
        if variant == DOUBLE_STYLE_DEFAULT:
            return base_segment, trim_segment(inner_full_seg, trim), (inner_nx, inner_ny)
        if variant == DOUBLE_STYLE_OUTER:
            return base_segment, trim_segment(outer_full_seg, trim), (inner_nx, inner_ny)
