...
from ui.canvas_view_ports import scene_pos_from_event_for_view
...
def build_selection_services(
    ...
    *,
    ...
    selection_structure_service = SelectionStructureService(canvas, graph_service=resolved_graph_service)
