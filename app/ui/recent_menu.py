...
from ui.recent_documents_logic import recent_menu_entries
from ui.recent_documents_store import clear_recent, load_recent
    ...
    *,
    ...
    def repopulate() -> None:
        ...
        for label, path in entries:
            ...
            action.triggered.connect(lambda _checked=False, target=path: open_path(target))
