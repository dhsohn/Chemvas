...
def _bond_preview_build_resolvers_for(canvas) -> BondPreviewBuildResolvers:
    return BondPreviewBuildResolvers(
        ...
        line_normal=lambda x1, y1, x2, y2, target: line_normal_for(canvas, x1, y1, x2, y2, target),
...
def build_bond_preview_items_for(canvas, start: QPointF, end: QPointF, *atom_ids) -> list:
