...
from ui.main_window_about_dialog import GITHUB_URL, show_about_dialog
...
def build_menu_bar(window) -> QMenuBar:
    ...
    github_action.triggered.connect(lambda _checked=False: QDesktopServices.openUrl(QUrl(GITHUB_URL)))
