...
def refresh_hover_from_cursor_for(
    ...
    *,
    ...
    if insert_state.template_active or insert_state.smiles_active:
        ...
        if scene_pos is not None and insert_state.template_active and callable(render_template_preview):
            render_template_preview(scene_pos)
        elif scene_pos is not None and insert_state.smiles_active and callable(render_smiles_preview):
