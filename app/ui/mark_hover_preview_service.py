...
from ui.canvas_hover_state import hover_state_for, set_hover_atom_id_for
...
class MarkHoverPreviewService:
    def __init__(self, canvas: CanvasView, *, hit_testing_service, hover_scene_service=None) -> None:
        self.canvas = canvas
