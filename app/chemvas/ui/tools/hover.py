...
from chemvas.ui.tools.hover_rendering import clear_hover_items
...
class HoverController:
    ...
    def _model(self) -> MoleculeModel:
        return cast("MoleculeModel", self.canvas.model)

    def _state(self) -> HoverState:
        return cast("HoverState", self.canvas.runtime_state.hover_preview_state)
