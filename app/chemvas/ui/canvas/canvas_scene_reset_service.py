...
from chemvas.ui.canvas.canvas_atom_graphics_state import clear_atom_graphics_for
from chemvas.ui.canvas.canvas_bond_graphics_state import clear_bond_graphics_for
...
class CanvasSceneResetService:
    def __init__(self, canvas, *, hit_testing_service) -> None:
        ...
        self.rotation = canvas.runtime_state.rotation_state
    ...
    def _runtime_reset_steps(self, empty_model: MoleculeModel) -> tuple:
        ...
        return (
            ...
            clear_hover,
            lambda: setattr(canvas, "model", empty_model),
    ...
    def clear_scene(self) -> None:
        ...
        try:
            ...
            if discard_history:
                try:
                    self.canvas.services.history_service.discard_without_notification()
                except Exception as error:
                    errors.append(error)
        finally:
