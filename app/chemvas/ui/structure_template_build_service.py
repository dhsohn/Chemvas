...
class StructureTemplateBuildService:
    ...
    def add_hetero_ring_template(
        self, n: int, elements: list[str], bond_orders: list[int] | None = None
    ) -> None:
        self.fragment_builder.add_hetero_ring_template(
            n, elements, self.actions(), bond_orders=bond_orders
        )
