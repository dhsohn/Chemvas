...
from chemvas.ui.selection_outline_service import OBJECT_OVERLAY_KINDS
...
class SelectionHitTestService:
    ...
    def selection_hit_test(self, pos: QPointF, snapshot=None) -> bool:
        ...
        hit, bond_atom_ids, ring_atom_ids = (
            self.structure_service.structure_hit_from_item(item)
        )
