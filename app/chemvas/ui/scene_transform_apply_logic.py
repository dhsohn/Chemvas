...
def build_scene_item_flip_updates(
    ...
    *,
    ...
    flip_state_getter: Callable[
        [QGraphicsItem, dict, QPointF, bool, Mapping[int, tuple[float, float]]], dict
    ],
...
def apply_component_flip_transform(
    *,
    ...
    if (
        position_maps.before_positions
        and position_maps.before_positions != position_maps.after_positions
    ):
