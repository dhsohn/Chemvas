...
def expanded_bold_segment(
    start: QPointF, end: QPointF, bond_length_px: float
) -> LineSegment:
    return start.x(), start.y(), end.x(), end.y()


def scale_segment_offset(
...
def plain_double_preview_segments(
    ...
    if style == DOUBLE_STYLE_DEFAULT:
        return (
            base,
            trim_segment(scale_segment_offset(second, base, side_scale), trim),
        )
