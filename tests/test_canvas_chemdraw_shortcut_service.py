...
class CanvasChemDrawShortcutServiceTest(unittest.TestCase):
    def test_object_and_generic_shortcuts_dispatch_expected_actions(self) -> None:
        ...
        scene_transform_controller = SimpleNamespace(
            flip_selected_items=lambda *, horizontal: calls.append(
                ("flip", horizontal)
            ),
            rotate_selected_items=lambda angle: calls.append(("rotate", angle)),
            translate_selected_items=lambda dx, dy: (
                calls.append(("translate", dx, dy)),
                True,
            )[1],
        )
        tool_mode_controller = SimpleNamespace(
            set_tool=lambda tool: calls.append(("tool", tool)),
            set_bond_style=lambda style, order: calls.append(
                ("bond_style", style, order)
            ),
            set_arrow_type=lambda arrow_type: calls.append(("arrow_type", arrow_type)),
            set_bracket_type=lambda bracket_type: calls.append(
                ("bracket_type", bracket_type)
            ),
            set_orbital_type=lambda orbital_type: calls.append(
        ...
        self.assertTrue(
            service.handle_object_shortcut(
                _FakeKeyEvent(Qt.Key.Key_Up, Qt.KeyboardModifier.AltModifier)
            )
        )
        self.assertTrue(
            service.handle_object_shortcut(
                _FakeKeyEvent(Qt.Key.Key_Down, Qt.KeyboardModifier.AltModifier)
            )
        )
        self.assertTrue(
            service.handle_object_shortcut(
                _FakeKeyEvent(Qt.Key.Key_Left, Qt.KeyboardModifier.AltModifier)
            )
        )
        self.assertTrue(
            service.handle_object_shortcut(
                _FakeKeyEvent(Qt.Key.Key_Right, Qt.KeyboardModifier.AltModifier)
            )
        )
        self.assertTrue(
            service.handle_object_shortcut(
                _FakeKeyEvent(Qt.Key.Key_Right, Qt.KeyboardModifier.ShiftModifier)
            )
        )
        ...
        self.assertTrue(
            service.handle_generic_hotkey(
                _FakeKeyEvent(Qt.Key.Key_T, Qt.KeyboardModifier.ShiftModifier)
            )
        )
        self.assertTrue(
            service.handle_generic_hotkey(
                _FakeKeyEvent(Qt.Key.Key_G, Qt.KeyboardModifier.ShiftModifier)
            )
        )
        self.assertTrue(
            service.handle_generic_hotkey(
                _FakeKeyEvent(Qt.Key.Key_E, Qt.KeyboardModifier.ShiftModifier)
            )
        )
        self.assertTrue(
            service.handle_generic_hotkey(
                _FakeKeyEvent(Qt.Key.Key_D, Qt.KeyboardModifier.AltModifier)
            )
        )
    ...
    def test_handle_shortcut_falls_through_to_generic_when_hover_handlers_miss(
        self,
    ) -> None:
    ...
    def test_atom_hotkey_routes_to_prompt_marks_labels_and_sprouts(self) -> None:
        ...
        canvas = SimpleNamespace(
            ...
            services=canvas_runtime_services(
                ...
                atom_label_service=SimpleNamespace(
                    add_or_update_atom_label=lambda atom_id, text, show_carbon=True: (
                        calls.append(("label", atom_id, text, show_carbon))
                    ),
                    prompt_atom_label=lambda atom_id: calls.append(("prompt", atom_id)),
                ),
                structure_build_service=SimpleNamespace(
                    sprout_bond_from_atom=lambda atom_id, style, order, cyclic=False: (
                        calls.append(("bond", atom_id, style, order, cyclic))
                    ),
                    sprout_acetyl_from_atom=lambda atom_id: calls.append(
                        ("acetyl", atom_id)
                    ),
                    sprout_benzene_from_atom=lambda atom_id: calls.append(
                        ("benzene", atom_id)
                    ),
                    sprout_dimethyl_from_atom=lambda atom_id: calls.append(
                        ("dimethyl", atom_id)
                    ),
                    sprout_regular_ring_from_atom=lambda atom_id, n: calls.append(
                        ("ring", atom_id, n)
                    ),
                ),
            ),
        ...
        self.assertFalse(
            service.handle_atom_hotkey(_FakeKeyEvent(Qt.Key.Key_C, text="c"), 99)
        )
        self.assertFalse(
            service.handle_atom_hotkey(
                _FakeKeyEvent(
                    Qt.Key.Key_C, Qt.KeyboardModifier.ControlModifier, text="c"
                ),
                1,
            )
        )
        ...
        self.assertTrue(
            service.handle_atom_hotkey(_FakeKeyEvent(Qt.Key.Key_Plus, text="+"), 1)
        )
        self.assertTrue(
        ...
        self.assertTrue(
            service.handle_atom_hotkey(_FakeKeyEvent(Qt.Key.Key_2, text="2"), 1)
        )
        self.assertTrue(
            service.handle_atom_hotkey(_FakeKeyEvent(Qt.Key.Key_3, text="3"), 1)
        )
        self.assertTrue(
            service.handle_atom_hotkey(_FakeKeyEvent(Qt.Key.Key_4, text="4"), 1)
        )
        self.assertTrue(
            service.handle_atom_hotkey(_FakeKeyEvent(Qt.Key.Key_5, text="5"), 1)
        )
        self.assertTrue(
            service.handle_atom_hotkey(_FakeKeyEvent(Qt.Key.Key_6, text="6"), 1)
        )
        self.assertTrue(
            service.handle_atom_hotkey(_FakeKeyEvent(Qt.Key.Key_7, text="7"), 1)
        )
        self.assertTrue(
            service.handle_atom_hotkey(_FakeKeyEvent(Qt.Key.Key_8, text="8"), 1)
        )
        self.assertTrue(
            service.handle_atom_hotkey(_FakeKeyEvent(Qt.Key.Key_9, text="9"), 1)
        )
        self.assertTrue(
            service.handle_atom_hotkey(_FakeKeyEvent(Qt.Key.Key_Z, text="z"), 1)
        )
        self.assertTrue(
            service.handle_atom_hotkey(_FakeKeyEvent(Qt.Key.Key_U, text="u"), 1)
        )
        self.assertTrue(
            service.handle_atom_hotkey(_FakeKeyEvent(Qt.Key.Key_V, text="v"), 1)
        )
        self.assertFalse(
            service.handle_atom_hotkey(_FakeKeyEvent(Qt.Key.Key_unknown, text=""), 1)
        )
        self.assertFalse(
            service.handle_atom_hotkey(_FakeKeyEvent(Qt.Key.Key_unknown, text="?"), 1)
        )
    ...
    def test_bond_hotkey_routes_to_style_and_fusion_actions(self) -> None:
        calls: list[tuple] = []
        scene_transform_controller = SimpleNamespace(
            apply_bond_style=lambda bond_id, style, order: calls.append(
                ("style", bond_id, style, order)
            )
        )
        canvas = SimpleNamespace(
            ...
            services=canvas_runtime_services(
                ...
                structure_build_service=SimpleNamespace(
                    ...
                    fuse_regular_ring_to_bond=lambda bond_id, n: calls.append(
                        ("ring", bond_id, n)
                    ),
                    fuse_chair_to_bond=lambda bond_id, mirrored=False: calls.append(
                        ("chair", bond_id, mirrored)
                    ),
                ),
            ),
        )
        ...
        self.assertFalse(
            service.handle_bond_hotkey(_FakeKeyEvent(Qt.Key.Key_1, text="1"), 1)
        )
        self.assertFalse(
            service.handle_bond_hotkey(
                _FakeKeyEvent(
                    Qt.Key.Key_1, Qt.KeyboardModifier.ControlModifier, text="1"
                ),
                0,
            )
        )
        self.assertTrue(
            service.handle_bond_hotkey(
                _FakeKeyEvent(
                    Qt.Key.Key_B, Qt.KeyboardModifier.ShiftModifier, text="B"
                ),
                0,
            )
        )
        self.assertTrue(
            service.handle_bond_hotkey(
                _FakeKeyEvent(
                    Qt.Key.Key_H, Qt.KeyboardModifier.ShiftModifier, text="H"
                ),
                0,
            )
        )
        self.assertTrue(
            service.handle_bond_hotkey(
                _FakeKeyEvent(
                    Qt.Key.Key_D, Qt.KeyboardModifier.ShiftModifier, text="D"
                ),
                0,
            )
        )
        self.assertTrue(
            service.handle_bond_hotkey(_FakeKeyEvent(Qt.Key.Key_D, text="d"), 0)
        )
        self.assertFalse(
            service.handle_bond_hotkey(_FakeKeyEvent(Qt.Key.Key_C, text="c"), 0)
        )
        self.assertTrue(
            service.handle_bond_hotkey(_FakeKeyEvent(Qt.Key.Key_C, text="c"), 2)
        )
        self.assertTrue(
            service.handle_bond_hotkey(_FakeKeyEvent(Qt.Key.Key_L, text="l"), 2)
        )
        self.assertTrue(
            service.handle_bond_hotkey(_FakeKeyEvent(Qt.Key.Key_R, text="r"), 2)
        )
        self.assertTrue(
            service.handle_bond_hotkey(_FakeKeyEvent(Qt.Key.Key_L, text="l"), 3)
        )
        self.assertTrue(
            service.handle_bond_hotkey(_FakeKeyEvent(Qt.Key.Key_C, text="c"), 3)
        )
        self.assertTrue(
            service.handle_bond_hotkey(_FakeKeyEvent(Qt.Key.Key_R, text="r"), 3)
        )
        self.assertTrue(
            service.handle_bond_hotkey(_FakeKeyEvent(Qt.Key.Key_1, text="1"), 0)
        )
        self.assertTrue(
            service.handle_bond_hotkey(_FakeKeyEvent(Qt.Key.Key_2, text="2"), 0)
        )
        self.assertTrue(
            service.handle_bond_hotkey(_FakeKeyEvent(Qt.Key.Key_3, text="3"), 0)
        )
        self.assertTrue(
            service.handle_bond_hotkey(_FakeKeyEvent(Qt.Key.Key_B, text="b"), 0)
        )
        self.assertTrue(
            service.handle_bond_hotkey(_FakeKeyEvent(Qt.Key.Key_W, text="w"), 0)
        )
        self.assertTrue(
            service.handle_bond_hotkey(_FakeKeyEvent(Qt.Key.Key_H, text="h"), 0)
        )
        self.assertTrue(
            service.handle_bond_hotkey(_FakeKeyEvent(Qt.Key.Key_A, text="a"), 0)
        )
        self.assertTrue(
            service.handle_bond_hotkey(_FakeKeyEvent(Qt.Key.Key_6, text="6"), 0)
        )
        self.assertTrue(
            service.handle_bond_hotkey(_FakeKeyEvent(Qt.Key.Key_0, text="0"), 0)
        )
        self.assertFalse(
            service.handle_bond_hotkey(_FakeKeyEvent(Qt.Key.Key_X, text="x"), 0)
        )
