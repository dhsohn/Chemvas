...
# A partial canvas has no renderer style to ask for the stroke pen.
plain_shape_pen = mock.patch.object(
    AnnotationGraphics, "shape_pen", lambda self, stroke_style="solid": QPen()
)
