...
class CanvasGeometryControllerTest(unittest.TestCase):
    ...
    def test_mark_clearance_for_kind_covers_radical_plus_minus_and_default(
        self,
    ) -> None:
    ...
    def test_trim_line_for_labels_handles_none_radii_and_min_span_clamp(self) -> None:
        ...
        self.assertEqual(
            controller.trim_line_for_labels(1, None, 0.0, 0.0, 100.0, 0.0), (0.0, 1.0)
        )
        self.assertEqual(
            controller.trim_line_for_labels(None, 1, 0.0, 0.0, 100.0, 0.0), (0.0, 1.0)
        )
    ...
    def test_trim_line_for_labels_uses_visible_label_rect_for_wide_aliases(
        self,
    ) -> None:
        canvas = SimpleNamespace(
    ...
    def test_trim_line_for_labels_clamps_start_only_and_end_only_min_span(self) -> None:
        ...
        self.assertEqual(
            controller.trim_line_for_labels(1, None, 0.0, 0.0, 100.0, 0.0), (0.98, 1.0)
        )
        self.assertEqual(
