...
class CanvasViewHoverHelperTest(unittest.TestCase):
    ...
    def test_emit_selection_info_uses_rdkit_cache_and_handles_unavailable_pending_and_empty_selections(
        ...
        self.assertEqual(
            loaded_view.runtime_state.selection_info_state.pending_signature, None
        )
        ...
        self.assertIsNone(empty_view.runtime_state.selection_info_state.signature)
        self.assertIsNone(
            empty_view.runtime_state.selection_info_state.pending_signature
        )
        self.assertEqual(empty_view.runtime_state.selection_info_state.cache, ("", ""))
        self.assertFalse(
            empty_view.runtime_state.selection_info_state.rdkit_warmup_pending
        )
        ...
        self.assertIsNone(unavailable_view.runtime_state.selection_info_state.signature)
        self.assertIsNone(
            unavailable_view.runtime_state.selection_info_state.pending_signature
        )
        self.assertEqual(
            unavailable_view.runtime_state.selection_info_state.cache, ("", "")
        )
        self.assertFalse(
            unavailable_view.runtime_state.selection_info_state.rdkit_warmup_pending
        )
        ...
        self.assertEqual(
            pending_view.runtime_state.selection_info_state.pending_signature,
    ...
    def test_maybe_warm_rdkit_handles_loaded_unavailable_and_idle_paths(self) -> None:
        ...
        self.assertFalse(
            loaded_view.runtime_state.selection_info_state.rdkit_warmup_pending
        )
        self.assertIsNone(
            loaded_view.runtime_state.selection_info_state.pending_signature
        )
        ...
        self.assertFalse(
            idle_view.runtime_state.selection_info_state.rdkit_warmup_pending
        )
        self.assertIsNone(
            idle_view.runtime_state.selection_info_state.pending_signature
        )
        ...
        self.assertTrue(
            busy_view.runtime_state.selection_info_state.rdkit_warmup_pending
        )
        self.assertEqual(
            busy_view.runtime_state.selection_info_state.pending_signature, ("pending",)
        )
