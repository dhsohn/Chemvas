...
class StructureGeometryLogicTest(unittest.TestCase):
    ...
    def test_compute_sprout_bond_endpoint_handles_default_and_cyclic_cases(
        self,
    ) -> None:
        atoms = {
            1: Atom("C", 0.0, 0.0),
    ...
    def test_compute_sprout_bond_endpoint_skips_zero_length_vectors_and_balanced_neighbors(
        self,
    ) -> None:
        atoms = {
            1: Atom("C", 0.0, 0.0),
    ...
    def test_compute_regular_ring_points_for_atom_forwards_geometry_inputs(
        self,
    ) -> None:
        atoms = {
            1: Atom("C", 0.0, 0.0),
    ...
    def test_compute_regular_ring_points_for_atom_returns_none_for_missing_atom_or_geometry_failure(
        self,
    ) -> None:
    ...
    def test_compute_regular_ring_points_for_bond_forwards_hint_and_polygon(
        self,
    ) -> None:
        atoms = {
            1: Atom("C", 0.0, 0.0),
    ...
    def test_compute_regular_ring_points_for_bond_and_template_return_none_for_invalid_or_missing_geometry(
        self,
    ) -> None:
        atoms = {
            1: Atom("C", 0.0, 0.0),
    ...
    def test_compute_template_points_for_bond_projects_template_and_validates_input(
        self,
    ) -> None:
        atoms = {
            1: Atom("C", 0.0, 0.0),
