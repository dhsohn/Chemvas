...
def test_structure_bond_build_service_updates_existing_bond_without_recording_addition() -> (
    None
):
    canvas = _FakeCanvas()
    builder = _builder_for(canvas)
...
def test_structure_bond_build_service_uses_hit_testing_service_for_snap_lookup() -> (
    None
):
    canvas = _FakeCanvas()
